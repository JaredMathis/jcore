...
export async function function_search_generic(query, query_map, candidate_as_string_matches, candidate_mapper) {
    ...
    let candidates_matching = search_generic(candidates, candidate_mapper, candidate_as_string_matches, query, query_map);
