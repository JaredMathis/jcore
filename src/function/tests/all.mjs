...
export async function function_tests_all(function_name) {
    ...
    let filtered = array_filter(all, a => string_starts_with(a, function_name + function_name_separator()));
    let filtered2 = array_filter(filtered, a => string_function_tests_name_is(a));
    return filtered2;
}