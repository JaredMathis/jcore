import { json_equals_keys_excluded } from '../../../../../json/equals/keys/excluded.mjs';
                    ...
                    if (equal(c_ce_name, function_name)) {
                        ...
                        list_each_with_index(ce_args, (ce_arg, ce_arg_index) => {
                            ...
                            if (ce_arg !== null) {
                                ...
                                let identical = json_equals_keys_excluded(arguments_assert_arg, c_arguments_assert_arg, [
