...
import { string_case_snake_to_pascal } from '../../../../../string/case/snake/to/pascal.mjs';
...
import { function_add_string_prefix_pascal_generic } from '../../../string/prefix/pascal/generic.mjs';
...
export async function function_add_js_node_type_snake(snake) {
    ...
    let camel_case = string_case_snake_to_pascal(snake);
    let function_name_js_node_type = js_identifier_combine(prefix_2, snake);
    let v_3 = boolean_value_false();
    let v_1 = await function_add_string_prefix_pascal_generic(prefix_2, camel_case, v_3);
