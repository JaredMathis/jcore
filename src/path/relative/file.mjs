...
comment(`For some reason ${path_relative.name} does not seem to work when the two paths are both files. This fixes it. At least for the purposes of determining a JavaScript import path`)
