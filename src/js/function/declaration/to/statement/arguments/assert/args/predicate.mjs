...
export async function js_function_declaration_to_statement_arguments_assert_args_predicate(function_declaration) {
    let {args} = await js_function_declaration_to_statement_arguments_assert_args_predicate_added(function_declaration);
    return args;
    metadata([]);
}

async function js_function_declaration_to_statement_arguments_assert_args_predicate_added(function_declaration) {
