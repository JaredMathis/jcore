...
export function string_difference_get2_recursive(left, right, left_offset, right_offset) {
    ...
    let left_result = string_difference_get2_recursive(left_left, right_left, left_offset, right_offset + offset);
    list_add_multiple(result, left_result);
    let right_result = string_difference_get2_recursive(left_right, right_right, left_offset + offset, right_offset);
